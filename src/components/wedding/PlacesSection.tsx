...
const places = [
  {
    ...
    mapUrl: 'https://maps.google.com/?q=Centre+État+Civil+Grand+Dakar',
    accentColor: 'gold',
    delay: 0,
  },
  {
    ...
    mapUrl: 'https://maps.google.com/?q=Église+Évangélique+Dakar',
  ...
  },
  {
    ...
    address: 'Point E, Dakar, Sénégal',
    mapUrl: 'https://maps.google.com/?q=Centre+Socio+Culturel+Point+E+Dakar',
